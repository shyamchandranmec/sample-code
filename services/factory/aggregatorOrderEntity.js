...
module.exports = app => {
    ...
    class AggregatorOnlineEntity extends BaseEntity {
        ...
        getEntityMetaValidationSchema () {
            return joi.object().keys({
                order_type: joi.string().valid("third_party").required(),
                ...
                customer_details: joi.object().required().keys({
                    ...
                    mobile: joi.string().max(15).allow(""),
                    address: joi.object().required().keys({
                        address: joi.string().required().allow(""),
                        landmark: joi.string().required().allow(""),
                        location_id: joi.number().required().allow(""),
                        location_name: joi.string().required().allow(""),
                        city_id: joi.number(),
